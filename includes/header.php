  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch w-100">
    ...
    <ul class="navbar-nav navbar-nav-left">
        <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Manage Events</a>
            <div class="dropdown-menu  navbar-dropdown" aria-labelledby="dropdown05">
            <a class="nav-link" href="manage_event.php">Manage Events Types</a>
              <a class="dropdown-item" href="event-list.php">Events</a>
            </div>
          </li>
